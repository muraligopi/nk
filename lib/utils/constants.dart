...
const Color kPrimaryColor = Color.fromARGB(255, 160, 74, 241);
const Color kBackgroundColor = Color.fromARGB(255, 138, 85, 170);
...
class AppConstants {
  static const linkedInUrl = "https://www.linkedin.com/in/";
  ...
  static const chat = _assets + "chat.json";
  ...
  static const nklogo = _techImages + "N.png";

  static const _projectsImages = _images + "projects/";
  static const mobilerecharge = _projectsImages + "1.jpeg";
  static const dthrecharge = _projectsImages + "2.jpeg";
  static const datarecharge = _projectsImages + "3.jpeg";
